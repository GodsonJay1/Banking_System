...
public class TransactionCellController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        receiver_lbl.textProperty().bind(transaction.recipientProperty());
        ...
        message_btn.setOnAction(event -> Model.getInstance().getViewFactory().showMessageWindow(transaction.senderProperty().get(), transaction.descriptionProperty().get()));
        transactionIcons();
    }
