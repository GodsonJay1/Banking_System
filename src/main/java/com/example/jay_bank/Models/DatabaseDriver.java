...
public class DatabaseDriver {
    ...
    public DatabaseDriver() {
        try {
            this.conn = DriverManager.getConnection("jdbc:sqlite:jaybank.db");
    ...
    public void newTransaction(String sender, String receiver, double amount, String message) {
        ...
        try {
            ...
            statement.executeUpdate("INSERT INTO" +
                    ...
                    "VALUES ('"+sender+"', '"+receiver+"', '"+date+"', '"+message+"');");
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    * */
    ...
    // Create New Client / Current Account // current accouts for db
    public void createCurrentAccount(String owner, String number, double tLimit, double balance) {
        Statement statement;
        try {
            statement = this.conn.createStatement();
            statement.executeUpdate("INSERT INTO " +
                    "CurrentAccounts (Owner, AccountNumber, TransactionLimit, Balance)" +
    ...
    // Create New Client / Savings Account // saving accounts for db
    ...
    * Utility Methods
    * */
    // To Generate a unique payee Address
    ...
    //ClientsController
    public ResultSet getCurrentAccountData(String pAddress) {
        Statement statement;
        ResultSet resultSet = null;
        try {
            statement = this.conn.createStatement();
            resultSet = statement.executeQuery("SELECT * FROM CurrentAccounts WHERE Owner='"+pAddress+"';");
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return resultSet;
